...
<div class="kt-portlet kt-portlet--mobile">
  ...
  <div class="kt-portlet__body">
    {{-- Begin::Contetn --}}
    <form action="{{ route('lectureHour.update', $lectureHour->id) }}" method="POST">
      <div class="kt-portlet__body">
        <div class="kt-section kt-section--first">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="time" id="time" placeholder="07.30 - 09.00" value="{{ $lectureHour->time }}" required autofocus>
          </div>
        </div>
      </div>
