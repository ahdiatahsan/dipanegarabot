...
@section('breadcrumbCategoryUrl', 'lectureHour')
  ...
  <div class="kt-portlet__head kt-portlet__head--lg">
    ...
    <div class="kt-portlet__head-toolbar">
      <div class="kt-portlet__head-wrapper">
          <a href="{{ route('lectureHour.create') }}" class="btn btn-brand btn-icon-sm"><i class="flaticon2-plus"></i>Tambah Data</a>
      </div>
    </div>
  </div>
          ...
          <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting kt-font-primary kt-font-bolder">Jam Perkuliahan</th>
...
<script type="text/javascript">
  $(document).ready(function () {
    $('#table').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: "{{ route('lectureHour.getData') }}",
      columns: [
