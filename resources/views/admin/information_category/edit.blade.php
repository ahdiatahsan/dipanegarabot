...
<div class="kt-portlet kt-portlet--mobile">
  ...
  <div class="kt-portlet__body">
    {{-- Begin::Contetn --}}
    <form action="{{ route('informationCategory.update', $informationCategory->id) }}" method="POST">
      <div class="kt-portlet__body">
        <div class="kt-section kt-section--first">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="name" id="name" placeholder="Perkuliahan" value="{{ old('name', $informationCategory->name) }}" required autofocus>
          </div>

          <div class="form-group">
            <label>Detail Kategori</label>
            <textarea class="form-control" name="detail" id="detail" rows="5">{{ old('name', $informationCategory->detail) }}</textarea>
          </div>
