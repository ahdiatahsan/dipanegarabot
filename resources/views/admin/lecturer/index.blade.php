  ...
  <div class="kt-portlet__head kt-portlet__head--lg">
    ...
    <div class="kt-portlet__head-toolbar">
      <div class="kt-portlet__head-wrapper">
          <a href="{{ route('lecturer.create') }}" class="btn btn-brand btn-icon-sm"><i class="flaticon2-plus"></i>Tambah Data</a>
      </div>
    </div>
  </div>
          ...
          <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting kt-font-primary kt-font-bolder">NIDN</th>
                <th class="sorting kt-font-primary kt-font-bolder">Nama Dosen</th>
                <th class="sorting kt-font-primary kt-font-bolder">Jenis Kelamin</th>
                <th class="sorting kt-font-primary kt-font-bolder">Pendidikan Tertinggi</th>
