      ...
      <div class="kt-portlet__body">
        <div class="kt-section kt-section--first">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="name" id="name" placeholder="Muzhawir Amri" value="{{ old('name', $user->name) }}" required autofocus>
          </div>

          <div class="form-group">
            <label>Email</label>
            <input class="form-control" type="email" name="email" id="email" placeholder="muzhawir.amri@mail.com" value="{{ old('email', $user->email) }}" required>
          </div>
          ...
          <div class="form-group">
            ...
            <select class="custom-select select2 select2-container" name="role_id" id="role_id">
              <option value="1" {{ ($user->role_id == 1) ? 'selected' : '' }}>Super Administrator</option>
