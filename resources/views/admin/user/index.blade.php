...
@section('breadcrumbCategoryUrl', 'user')
  ...
  <div class="kt-portlet__head kt-portlet__head--lg">
    ...
    <div class="kt-portlet__head-toolbar">
      <div class="kt-portlet__head-wrapper">
          <a href="{{ route('user.create') }}" class="btn btn-brand btn-icon-sm"><i class="flaticon2-plus"></i>Tambah Data</a>
      </div>
    </div>
  </div>
          ...
          <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting kt-font-primary kt-font-bolder">Nama User</th>
                <th class="sorting kt-font-primary kt-font-bolder">Email</th>
                <th class="sorting kt-font-primary kt-font-bolder">Peran</th>
