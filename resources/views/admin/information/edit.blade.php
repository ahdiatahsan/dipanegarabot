      ...
      <div class="kt-portlet__body">
        <div class="kt-section kt-section--first">
          ...
          <div class="form-group">
              ...
              <input class="form-control" type="text" name="name" id="name" placeholder="Kalender Pendidikan 2019/2020" value="{{ old('name', $information->name) }}" required autofocus>
            </div>
            ...
            <div class="form-group">
              ...
              <select class="custom-select select2 select2-container" name="information_category_id" id="information_category_id">
                ...
                <option value="{{ $informationCategory->id }}" {{ ($informationCategory->name == $informationCategory->name) ? 'selected' : '' }}>{{ $informationCategory->name }}</option>
                @endforeach
              </select>
            </div>
