...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
  ...
  <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
      <a href="/">
        <img alt="Logo" src="{{ asset('media/dashboard-logo.png') }}" width="10%" />
      </a>
    </div>
        ...
        <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
          <div class="kt-aside__brand-logo">
            <a href="/" class="text-center">
              <img alt="Logo" src="{{ asset('media/dashboard-logo.png') }}" width="15%" />
            </a>
          </div>
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
          ...
          <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
              <h3 class="kt-subheader__title">@yield('breadcrumbGroup') </h3>
              ...
              <div class="kt-subheader__breadcrumbs">
                ...
                <a href="@yield('breadcrumbCategoryUrl')" class="kt-subheader__breadcrumbs-link">
                  @yield('breadcrumbCategoryName')
                </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="@yield('breadcrumbPageUrl')" class="kt-subheader__breadcrumbs-link">
                  @yield('breadcrumbPageName')
                </a>
  ...
  <!-- begin::Scrolltop -->
  <div id="kt_scrolltop" class="kt-scrolltop kt-bg-fill-danger">
